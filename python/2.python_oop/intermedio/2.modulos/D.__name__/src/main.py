...
from .funcoes import gera_palavra_aleatoria
from .funcoes import imprime_jogo
from .funcoes import jogar_novamente
from .funcoes import le_palavras
from .funcoes import recebe_palpite
from .funcoes import verifica_se_ganhou
